...
public class SearchPanel extends AbstractPanel{
    ...
    private Group drawAdvancedSearch(Composite parent) {
        ...
        final Button btnAndOr1= new  Button(grpAdvanced, SWT.BORDER);
        btnAndOr1.setText("And");
        btnAndOr1.setLayoutData(new GridData(SWT.LEFT,SWT.FILL, false, false, 2, 1));
        btnAndOr1.addListener(SWT.Selection, new Listener() {
            public void handleEvent(Event e) {
                if(btnAndOr1.getText().equalsIgnoreCase("And")){
        ...
        Button btnAndOr2= new  Button(grpAdvanced, SWT.BORDER);
        btnAndOr2.setText("And");
        btnAndOr2.setLayoutData(new GridData(SWT.LEFT,SWT.FILL, false, false, 2, 1));
        ...
        Button btnAndOr3= new  Button(grpAdvanced, SWT.BORDER);
        btnAndOr3.setText("And");
        btnAndOr3.setLayoutData(new GridData(SWT.LEFT,SWT.FILL, false, false, 2, 1));
